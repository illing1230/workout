...
export default function EditWorkoutModal({ visible, onClose, onUpdate, selectedDate, workout }) {
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <LinearGradient colors={gradients.secondary} style={styles.modalHeader}>
          ...
          <View style={styles.modalFooter}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <LinearGradient colors={gradients.secondary} style={styles.updateButtonGradient}>
